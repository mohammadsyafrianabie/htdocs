...
?>
                                                    ...
                                                    <td> <div class="table-data-feature">
                                                            <button class="item"type="button" data-toggle="modal" data-target="#updatemodal">
...
<form method="post" action="proses_simpan.php" enctype="multipart/form-data">
            ...
            <!-- modal scroll -->
            <div class="modal fade" id="updatemodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true" method="post">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Ubah Info Oli dan Sparepart</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
...
<form method="post" action="proses_ubah.php?id_info=<?php echo $id_info; ?>" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label for="name_oli" class=" form-control-label">Nama</label>
                                ...
                                <div class="form-group">
                                    <label for="deskripsi" class="form-control-label">Deskripsi</label>
                                    <textarea type="text" id="deskripsi" name="deskripsi" value="<?php echo $data['deskripsi']; ?>" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="gambar" class="form-control-label">Gambar</label>
                                    <input type="file" id="gambar" name="gambar" class="form-control-file">
